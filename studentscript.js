...
// // 🔹 existing code stays exactly as it is above

// // =======================
// // ✅ ADDED CODE (DO NOT REMOVE EXISTING CODE ABOVE)
// // =======================
// function updatePractice(subject) {
//     fetch(`/practice-data/${subject}`)
//         .then(res => res.json())
...
// document.addEventListener("DOMContentLoaded", loadPracticeTable);

// // -----------------
// document.addEventListener("DOMContentLoaded", () => {
//     if (typeof updatePractice === "function") {
//         updatePractice(document.getElementById("subjectSelect").value);
//     }
// });
